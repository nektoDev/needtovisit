    ...
    <ol class="property-list place">
        ...
        <g:if test="${placeInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${placeInstance}"
                                                                                        field="name"/></span>
        ...
        <g:if test="${placeInstance?.userRelation}">
            <li class="fieldcontain">
                <span id="userRelation-label" class="property-label"><g:message code="place.userRelation.label"
                                                                                default="User Relation"/></span>

                <g:each in="${placeInstance.userRelation}" var="u">
                    <span class="property-value" aria-labelledby="userRelation-label"><g:link
