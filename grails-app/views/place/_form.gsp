...
<div class="fieldcontain ${hasErrors(bean: placeInstance, field: 'userRelation', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="userPlaceRelation" action="create"
                    params="['place.id': placeInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'userPlaceRelation.label', default: 'UserPlaceRelation')])}</g:link>
        </li>
    </ul>
